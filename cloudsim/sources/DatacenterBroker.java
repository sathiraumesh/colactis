/*------------------------------------------------------------------------
 * 
 * This file is an edited version of the original DatacenterBroker.java file
...
import cloudsim.sources.bsopso.CloudLetPSOScheduling;
	...
	public void psoScheduling(){
		...
		if(usePSO){
			...
			for(int i = 0 ; i < cloudletList.size(); i++){
				cloudletList.get(i).setVmId(newPostitionsOnVMs[i]);
			}
